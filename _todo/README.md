...
폴더 이동 직전인 `14ae8d09^`의 원문을 복구했다. 반영·철회된 제안과 사용자 의견이 섞여 있으므로, 당시의 “현재”·“미해결” 표기를 오늘의 할 일로 그대로 적용하지 않는다.

- [영화·극장 삭제와 상영 생성의 경합](catalog-deletion-showtime-creation-race.md)
- [docs/reference 검토](docs-reference-review.md)
- [저장소 단순화 검토](repository-simplification-review.md)
- [시드 프로젝트 전체 검토](seed-project-review.md)

## 더 이전에 삭제된 기록

삭제 직전 원문도 복구했다. 완료 여부와 현재 유효성을 다시 확인할 자료이며, 보관본의 내용과 옛 링크는 수정하지 않는다.

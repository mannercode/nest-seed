 ...
 * 선점한다. 그다음 각 사용자가 각자의 쌍에 대해 결제 요청 여러 건을 동시에 보낸다.
 * 그룹마다 정확히 한 요청만 2xx로 성공하고, 나머지는 4xx(409 AlreadySold 또는 400
 * NotHeld)이다.
 *
 * 영화, 극장, 사용자 계정은 회차 바깥에서 한 번만 만든다. 매 회차마다 상영, 티켓,
 * 선점, 경쟁만 새로 실행한다.
 *
 * 어떤 그룹의 성공 응답 수가 1이 아니거나, 5xx가 발생하거나, 응답한 복제본 수가 두 개보다
 * 적으면 실패로 본다.
 */

import { AppLoggerService } from '../logger/index.js'
...
export class RestateEndpoint implements OnApplicationBootstrap, OnApplicationShutdown {
    private boundPort = 0
    private server?: Http2Server
    private readonly sessions = new Set<ServerHttp2Session>()

    constructor(
        private readonly services: Parameters<typeof createEndpointHandler>[0]['services'],

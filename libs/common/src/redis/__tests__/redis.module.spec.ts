...
import type { RedisModuleFixture } from './redis.module.fixture.js'
...
describe('RedisModule', () => {
    describe('forRoot', () => {
        it('URL로 연결할 수 있다', async () => {
            const { createRedisModuleFixture } = await import('./redis.module.fixture.js')
        ...
        it('커넥션 이름을 지정해 연결할 수 있다', async () => {
            const { createRedisModuleNamedFixture } = await import('./redis.module.fixture.js')
        ...
        it('URL과 옵션을 함께 주면 연결할 수 있다', async () => {
            const { createRedisModuleUrlWithOptionsFixture } =
                await import('./redis.module.fixture.js')
        ...
        it('URL과 함께 준 옵션이 실제 연결에 적용된다', async () => {
            const { createRedisModuleDbSelectionFixture } =
                await import('./redis.module.fixture.js')
    ...
    describe('forRootAsync', () => {
        ...
        beforeEach(async () => {
            const { createRedisModuleAsyncFixture } = await import('./redis.module.fixture.js')

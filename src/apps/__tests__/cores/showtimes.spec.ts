...
describe('ShowtimesService', () => {
    ...
    describe('searchShowtimes()', () => {
        ...
        describe('when filtering with various criteria', () => {
            // 기대 결과: transaction ID로 필터링된 상영시간 목록을 반환한다.
            ...
            // 기대 결과: movie ID로 필터링된 상영시간 목록을 반환한다.
            ...
            // 기대 결과: theater ID로 필터링된 상영시간 목록을 반환한다.
            ...
            // 기대 결과: 시작 시간 범위로 필터링된 상영시간 목록을 반환한다.
    ...
    describe('getShowtimes()', () => {
        ...
        // 상황: 상영시간 중 일부가 존재하지 않을 때
        describe('when any showtime does not exist', () => {
            // 기대 결과: "문서를 찾을 수 없음" 에러를 던진다.
    ...
    describe('searchShowingMovieIds()', () => {
        // 기대 결과: 현재 상영 중이거나 곧 상영될 영화의 ID 목록을 반환한다.
    ...
    describe('searchTheaterIds()', () => {
        // 기대 결과: 특정 영화를 상영하는 영화관의 ID 목록을 반환한다.
    ...
    describe('searchShowdates()', () => {
        // 기대 결과: 특정 영화와 영화관의 상영 가능 날짜 목록을 반환한다.
